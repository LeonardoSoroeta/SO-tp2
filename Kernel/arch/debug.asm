...
os_dump_regs:
	...
	mov qword [screen_cursor_offset], 0x00000000000B8000
	mov byte [screen_cursor_x], 0
	mov byte [screen_cursor_x], 0
...
os_dump_regs_again:
	; mov byte [screen_cursor_x], 0
	; mov byte [screen_cursor_y], 0
	;mov qword [screen_cursor_offset], 30000
...
os_dump_reg_string00: db 'RAX:', 0
os_dump_reg_string01: db 'RBX:', 0
os_dump_reg_string02: db 'RCX:', 0
os_dump_reg_string03: db 'RDX:', 0
os_dump_reg_string04: db 'RSI:', 0
os_dump_reg_string05: db 'RDI:', 0
os_dump_reg_string06: db 'RBP:', 0
os_dump_reg_string07: db 'RSP:', 0
os_dump_reg_string08: db ' R8:', 0
os_dump_reg_string09: db ' R9:', 0
os_dump_reg_string0A: db 'R10:', 0
os_dump_reg_string0B: db 'R11:', 0
os_dump_reg_string0C: db 'R12:', 0
os_dump_reg_string0D: db 'R13:', 0
os_dump_reg_string0E: db 'R14:', 0
os_dump_reg_string0F: db 'R15:', 0
...
OSVariables:	equ 0x00000000003F0000	
screen_cursor_offset:	equ OSVariables + 0x08
screen_cursor_x:	equ OSVariables + 386
screen_cursor_y:	equ OSVariables + 387
; -----------------------------------------------------------------------------
